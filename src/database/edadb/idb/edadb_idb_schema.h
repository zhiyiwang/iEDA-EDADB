...
TABLE4CLASS(idb::edadb_adapter::SpecialNetPinRef, "iSpecPinRef", (instance_name, pin_name));
...
TABLE4CLASS(idb::edadb_adapter::NetPinRef, "iNetPinRef", (instance_name, pin_name));
