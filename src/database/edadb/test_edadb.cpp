...
//void init(idb::IdbLayer* l)
//{
//    if (l == nullptr) return;
//
//    // define global object and set values for test
//    l->_name = "TEST_LAYER";
//    l->_type = idb::IdbLayerType::kLayerMasterslice;
//    l->_layer_id = 10;
//    l->_layer_order = 1;
//} // initLayer


//void init(idb::IdbLayerShape* s)
//{
//    if (s == nullptr) return;
//
//    // define global object and set values for test
//    s->_type = idb::IdbLayerShapeType::kRect;
//    s->_layer = new idb::IdbLayer();
//    init(s->_layer);
//    s->add_rect(IdbRect(100, 200, 300, 400));
//} // initLayerShape
...
//bool verifyEqual(const idb::IdbLayer* org, const idb::IdbLayer* got)
//{
//    if (org == nullptr || got == nullptr) return false;
//
//    CALL_COMPARE_MACRO(org->_name, got->_name, "name");
//    CALL_COMPARE_MACRO(org->_type, got->_type, "type");
//    CALL_COMPARE_MACRO(org->_layer_id, got->_layer_id, "layer_id");
//    CALL_COMPARE_MACRO(org->_layer_order, got->_layer_order, "layer_order");
//    return true;
//}


//bool verifyEqual(const idb::IdbLayerShape* org, const idb::IdbLayerShape* got)
//{
//    if (org == nullptr || got == nullptr) return false;
//
//    if (org->_layer == nullptr || got->_layer == nullptr) {
//        if (org->_layer != got->_layer) {
//            std::cerr << "Error: layer mismatch" << std::endl;
//            return false;
//        }
//    } else {
//        if (!verifyEqual(org->_layer, got->_layer)) {
//            std::cerr << "Error: layer mismatch" << std::endl;
//            return false;
//        }
//    }
//    CALL_COMPARE_MACRO(org->_type, got->_type, "type");
//
//    IdbRect* org_rect = org->get_rect(0);
//    IdbRect* got_rect = got->get_rect(0);
//    verify
//
//
//    return true;
