...
bool DefWriteEdadb::writeDb2Edadb(const char* edadb_path) {
    edadb_adapter::stage_timing::Session timing("write");
    ...
    {
        // P4: one design transaction; conversion, commit/rollback and cleanup stay in Data.
...
int32_t DefWriteEdadb::writeIdbInstance(void) {
    ...
    // Keep one root Shadow alive; reuse SQL and the outer design transaction.
